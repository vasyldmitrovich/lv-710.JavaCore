...
//        [Person [name=Ivan], Student [name=Petro, studyPlace=University, studyYears=3], Worker [name=Andriy,
//        workPosition=Developer, experienceYears=12], Student [name=Stepan, studyPlace=College, studyYears=4],
//        Worker [name=Ira, workPosition=Manager, experienceYears=8], Student [name=Ihor, studyPlace=University, studyYears=4]]
//        you should get
//        [Worker [name=Andriy, workPosition=Developer, experienceYears=12], Student [name=Stepan,
//        studyPlace=College, studyYears=4], Student [name=Ihor, studyPlace=University, studyYears=4]]
public class App {
    public static void main(String[] args) {
        com.softserve.extra02.Utils.MyUtils.run();
    }
}
