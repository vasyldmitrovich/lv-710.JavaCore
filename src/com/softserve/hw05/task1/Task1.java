...
public class Task1 {
    public static void runTask1() {
        ...
        System.out.println(new Task1().getResult(amountDaysOfEachMonth, month));
    }

    public String getResult(int[] amountDaysOfEachMonth, int month) {
        try {
            return "The " + month + " month contains " + amountDaysOfEachMonth[month - 1] + " days";
        } catch (IndexOutOfBoundsException e) {
            return month + " month is not exist";
        }
    }
}
